...
const DICT: DictField[] = [
  { canonical_name: 'resident_id', data_type: 'text', is_text_safe: 1, is_identity: 1, is_sensitive: 0, distribute_to_captain: 1, default_policy: 'never', aliases: ['resident id'] },
  { canonical_name: 'Cell', data_type: 'text', is_text_safe: 0, is_identity: 0, is_sensitive: 1, distribute_to_captain: 1, default_policy: 'fill_blank', aliases: ['mobile'] },
  { canonical_name: 'Damage', data_type: 'text', is_text_safe: 0, is_identity: 0, is_sensitive: 0, distribute_to_captain: 1, default_policy: 'fill_blank', aliases: [] },
  { canonical_name: 'Build Status', data_type: 'text', is_text_safe: 0, is_identity: 0, is_sensitive: 0, distribute_to_captain: 1, default_policy: 'overwrite', aliases: [] },
];
